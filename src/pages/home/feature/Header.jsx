...
const Header = () => {
  ...
  return (
    <section className="relative bg-[url('/path/to/your/background-image.jpg')] bg-cover bg-center bg-no-repeat py-10 px-4 lg:rounded-b-[60%]">
      <img
        src={HeaderBG}
        alt="Background"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mt-12">
          ...
          <p className="text-sm sm:text-base max-w-[60%] mx-auto text-[#0B1411B2] font-sans">
        ...
        <div className="relative overflow-hidden mt-24">
          ...
          {screenSize !== "tablet" && (
            <div
              className="absolute top-1/2 right-2 sm:right-4 lg:mr-20 transform -translate-y-1/2 z-50 bg-black text-white rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center cursor-pointer hover:bg-gray-800 transition"
              onClick={handleNext}
            >
              <img
                src={Arrow}
